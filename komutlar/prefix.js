...
exports.run = async (client, message, args) => {
  ...
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send("Gerekli yetkiye sahip değilsin. HA HA HA");
  if(!args[0] || args[0 == "yardım"]) return message.reply("Kullanımı: `nt!prefix <Yeni prefix>`");
